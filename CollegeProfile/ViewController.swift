...
class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        //Initializing sample
        colleges.append(College(name: "UCSD", state: "California", population: 32000, image: (UIImage(named: "ucsd")!), url: "https://www.ucsd.edu"))
        colleges.append(College(name: "UCLA", state: "California", population: 43000, image: (UIImage(named: "ucla")!), url: "https://www.ucla.edu"))
        colleges.append(College(name: "UIC", state: "Illinois", population: 16000, image: (UIImage(named: "uic")!), url: "https://www.uic.edu"))
        colleges.append(College(name: "Harvard", state: "Massachussets", population: 16000, image: (UIImage(named: "harvard")!), url: "https://www.harvard.edu"))
        colleges.append(College(name: "Princeton", state: "New Jersey", population: 3000, image: (UIImage(named: "princeton")!), url: "https://www.princeton.edu"))
    }
